...
public class CSRelationUserGatewayMessage extends  Message {
     ...
     * set once token
     */
    public CSRelationUserGatewayMessage setOnceToken(long onceToken) {
    ...
    public String toString() {
        return "CSRelationUserGatewayMessage[1101]{"
                +"token=" + token
                +",userId=" + userId
                +",onceToken=" + onceToken
                + "}";
    ...
    public String toString(String indent) {
        ...
        sb.append("CSRelationUserGatewayMessage").append("[1101]").append("{");
        //channel token
        sb.append("\n");
